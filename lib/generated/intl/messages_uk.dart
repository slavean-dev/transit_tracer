...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(version) => "Версія ${version}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "aboutSubtitle": MessageLookupByLibrary.simpleMessage(
      "Помічник з перевезення вантажів",
    ),
    "aboutTheAppContent": MessageLookupByLibrary.simpleMessage(
      "TransitTracer допомагає клієнтам швидко знаходити водіїв для перевезення вантажів, зберігаючи процес простим, безпечним та прозорим.",
    ),
    ...
    "dropMenuItemIt": MessageLookupByLibrary.simpleMessage("Італійська"),
    "dropMenuItemUkr": MessageLookupByLibrary.simpleMessage("Українська"),
    ...
    "passwordForm": MessageLookupByLibrary.simpleMessage("Введіть ваш Пароль"),
